...
@Autonomous(name="EXPERIMENTAL BLUE - FAR - 6 BALL", group="0")
public class SixBallBlueThanksEli extends LinearOpMode {
...
//        }
        ...
        driveForwardInches(16, 0.35, lf, lb, rf, rb, pinpoint);//0.4 16.5

        turnToAngle(startHeading + 90, imu, lf, lb, rf, rb); // turn to face spike BLUE

        //go pick up spike line
        driveForwardInches(37.5, 0.75, lf, lb, rf, rb, pinpoint);// this is moving  little
        ...
        driveInches(-26.5, 0.75, lf, lb, rf, rb, pinpoint);//Return back to the center feild
        ...
        driveInches(-9, 0.5, lf, lb, rf, rb, pinpoint);//Return to shooting line
...
//    }
    ...
    void doManipAndShoot(DcMotor manip, double revolutions) {
        ...
        while (opModeIsActive()
                && Math.abs(manipPID.getError(manip.getCurrentPosition())) > 0.35//0.25
