...
@Autonomous(name="RED - FAR - 3 BALL", group="0")
public class ThreeBallRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while((TurnTmer.seconds() < 2.5)){// && (!withinTolerance)){// 3 seconds of correcting
            double rx = 0;
        ...
        driveForwardInches(16, 0.25, lf, lb, rf, rb, pinpoint);
